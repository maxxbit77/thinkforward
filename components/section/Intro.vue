...
<template>
	...
	<!-- <div class="flex justify-center -space-x-12 max-w-5xl mx-auto">
		<div class="hover:z-50 hover:scale-125 transition-all duration-300">
			<CardBasic
				:background="card1.background"
				:icon="card1.icon"
				:iconClass="card1.iconClass"
				:customClass="card1.customClass"
			>
				<template #title>
					{{ card1.title }}
				</template>
		...
		<div class="hover:z-50 hover:scale-125 transition-all duration-300">
			<CardBasic
				...
				:icon="card2.icon"
				:iconClass="card2.iconClass"
				:customClass="card2.customClass"
			>
				<template #title>
					{{ card2.title }}
				</template>
		...
		<div class="hover:z-50 hover:scale-125 transition-all duration-300">
			<CardBasic
				...
				:icon="card3.icon"
				:iconClass="card3.iconClass"
				:customClass="card3.customClass"
			>
				<template #title>
					{{ card3.title }}
				</template>
		...
		<div class="hover:z-50 hover:scale-125 transition-all duration-300">
			<CardBasic
				...
				:icon="card4.icon"
				:iconClass="card4.iconClass"
				:customClass="card4.customClass"
			>
				<template #title>
					{{ card4.title }}
				</template>
